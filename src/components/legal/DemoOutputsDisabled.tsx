        ...
        <div className="flex items-start gap-3 text-sm text-warning-foreground">
          ...
          <div className="space-y-2">
            <p>
              ...
              prototype environments where mock-only surfaces such as demo team data are expected.
            </p>
            <p>
              Production environments must keep this disabled until persisted team-management APIs
              replace the remaining mock data paths.
            </p>

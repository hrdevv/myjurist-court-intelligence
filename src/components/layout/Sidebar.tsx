  ...
  return (
    <div className="flex h-full flex-col">
      <div className="px-5 py-5 border-b border-sidebar-border flex items-center gap-2">
        <div className="size-9 rounded-md bg-sidebar-accent flex items-center justify-center shrink-0">
          <Scale className="size-5" />
        </div>
        <div className="min-w-0">
          <div className="font-serif text-base leading-tight truncate">Courtroom</div>
